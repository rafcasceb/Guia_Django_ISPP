...
class HotelViewSet(viewsets.ViewSet):
    ...
    def list(self, request):  # GET /api/hotels/
    ...
    def retrieve(self, request, pk=None):  # GET /api/hotels/{id}/
    ...
    def create(self, request):  # POST /api/hotels/
        """Crea un nuevo hotel"""
    ...
    def destroy(self, request, pk=None):  # DELETE /api/hotels/{id}/
    ...
    @action(detail=False, methods=['get'], url_path="cities", url_name="get_all_cities")  # GET /api/hotels/cities
    ...
    @action(detail=True, methods=['get'], url_path="name", url_name="get_name_by_hotel_id")  # GET /api/hotels/{id}/name
    ...
    @action(detail=False, methods=['get'], url_path="city-summary/(?P<city>[\w\s-]+)", url_name="get_summary_by_city")  # GET /api/hotels/city-summary/{city}
    ...
    @action(detail=False, methods=['get'], url_path="filter", url_name="filter")  # GET /api/hotels/filter?name={name}&city={city}
